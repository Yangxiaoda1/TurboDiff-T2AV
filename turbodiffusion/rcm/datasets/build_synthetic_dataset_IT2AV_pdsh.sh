...
for i in "${!node_ips[@]}"; do
    ...
    pdsh -w "$ip" "cd ${REPO_ROOT} && \
        ...
        torchrun --nnodes=${NNODES} --node_rank=${node_rank} --nproc_per_node=${NPROC_PER_NODE} \
          ...
          --input_dir \"/apdcephfs_gy5/share_302507476/xiaodayang/TurboDiffusion-Data/TrainPrepare/mova-data/datasets\" \
          --output_dir \"/apdcephfs_gy5/share_302507476/xiaodayang/TurboDiffusion-Data/TrainPrepare/mova-data-output193\" \
